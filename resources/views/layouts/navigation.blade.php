        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ Auth::check() && (Auth::user()->is_admin ?? false) ? route('admin.halls.index') : (route('home') ?? '/') }}">
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        @if (Route::has('register'))
                            <a href="{{ route('register') }}" 
                               class="inline-flex items-center px-4 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-white bg-gray-800 dark:bg-gray-200 hover:bg-gray-700 dark:hover:bg-white focus:outline-none transition ease-in-out duration-150">
                                {{ __('Register') }}
                            </a>
                        @endif
                    </div>
