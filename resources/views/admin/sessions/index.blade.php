                                    ...
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            ...
                                            <form method="POST" action="{{ route('admin.sessions.destroy', $session->id) }}" class="inline">
                                                ...
                                                @method('DELETE')
                                                <button type="submit" 
                                                        onclick="return confirm('Вы уверены, что хотите удалить этот сеанс?')"
                                ...
                                @empty
                                    <tr>
                                        <td colspan="5" class="px-6 py-4 text-center text-sm text-gray-500 dark:text-gray-400">
                                            Сеансы не найдены. <a href="{{ route('admin.sessions.create') }}" class="text-indigo-600 dark:text-indigo-400 hover:underline">Создать первый сеанс</a>
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
