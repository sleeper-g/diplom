                                ...
                                @forelse($halls ?? [] as $hall)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            ...
                                            <form method="POST" action="{{ route('admin.halls.destroy', $hall->id) }}" class="inline">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" 
                                ...
                                @empty
                                    <tr>
                                        <td colspan="5" class="px-6 py-4 text-center text-sm text-gray-500 dark:text-gray-400">
                                            Залы не найдены. <a href="{{ route('admin.halls.create') }}" class="text-indigo-600 dark:text-indigo-400 hover:underline">Создать первый зал</a>
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
